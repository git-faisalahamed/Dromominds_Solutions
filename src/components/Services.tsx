...
export const Services = () => {
  ...
  return (
    <section id="services" className="bg-[#f8fafc] relative z-10 rounded-t-[2.5rem] md:rounded-t-[3.5rem] -mt-6 md:-mt-10 py-20 px-6 md:px-12 lg:px-24 overflow-hidden border-b border-gray-100 shadow-[0_-20px_40px_-20px_rgba(0,0,0,0.1)]">
      ...
      <div className="max-w-6xl mx-auto text-center mb-16 relative z-10">
        <h2 className="text-3xl md:text-5xl font-serif mb-4 text-slate-900 tracking-tight">The Life Sciences <span className="italic text-[var(--color-brand)]">Compliance Imperative</span></h2>
        <p className="text-gray-500 max-w-3xl mx-auto mb-12 text-sm md:text-base font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 items-stretch text-left relative shadow-lg rounded-2xl bg-white ring-1 ring-gray-100">
          <div className="p-6 md:p-10 flex flex-col relative transition-all duration-500 hover:bg-slate-50/50 rounded-l-2xl z-0 overflow-hidden group">
            ...
            <h3 className="text-lg font-bold mb-3 text-slate-900 group-hover:text-[var(--color-brand)] transition-colors">The Validation Gap</h3>
            <p className="text-gray-500 text-xs md:text-sm leading-relaxed mb-4 flex-grow font-light">
          ...
          <div className="bg-[#0f172a] text-white rounded-2xl p-6 md:p-10 shadow-xl transform md:-translate-y-2 md:scale-105 z-10 flex flex-col relative overflow-hidden border border-slate-800">
            ...
            <h3 className="text-xl font-serif mb-3 relative z-10">The Regulatory Convergence</h3>
            <p className="text-gray-300 text-xs md:text-sm leading-relaxed mb-4 flex-grow relative z-10 font-light">
          ...
          <div className="p-6 md:p-10 flex flex-col relative transition-all duration-500 hover:bg-slate-50/50 rounded-r-2xl z-0 overflow-hidden group">
            ...
            <h3 className="text-lg font-bold mb-3 text-slate-900 group-hover:text-[var(--color-brand)] transition-colors">The Competitive Window</h3>
            <p className="text-gray-500 text-xs md:text-sm leading-relaxed mb-4 flex-grow font-light">
      ...
      <div className="max-w-6xl mx-auto border-t border-gray-100 pt-10 mt-8">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-4xl font-serif mb-4 text-slate-900 tracking-tight">Enterprise Capabilities</h2>
          <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch text-left">
          {displayServices.map((svc: any, idx: number) => {
            ...
            return (
              <div key={idx} className="bg-white rounded-2xl p-6 lg:p-8 border border-gray-100 hover:border-transparent hover:ring-2 hover:ring-[var(--color-brand)] hover:shadow-lg hover:-translate-y-1 transition-all duration-500 flex flex-col group relative overflow-hidden">
                ...
                <div className="relative z-10 w-12 h-12 bg-slate-50 border border-slate-100 text-[var(--color-brand)] rounded-xl flex items-center justify-center mb-6 group-hover:bg-[var(--color-brand)] group-hover:text-white transition-colors duration-500 shadow-sm">
                  <IconComponent className="w-6 h-6" />
                </div>
                <h3 className="relative z-10 text-lg font-bold mb-3 text-slate-900">{svc.title}</h3>
                <p className="relative z-10 text-gray-500 text-xs md:text-sm leading-relaxed mb-6 flex-grow font-light">
                  {svc.description}
                </p>
                <Link to={svc.link} className="relative z-10 text-[var(--color-brand)] font-bold text-xs tracking-wide uppercase flex items-center gap-2 group-hover:gap-3 transition-all mt-auto">
