...
import { Pill, Dna, Activity, Search, Building2, Microchip } from 'lucide-react';
          ...
          {industries.map((ind, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-[11px] sm:text-xs md:text-base text-gray-500 dark:text-gray-400 leading-relaxed font-light flex-grow">{ind.desc}</p>
